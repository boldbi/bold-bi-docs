...
![Multiple Selection](/static/assets/cloud/visualizing-data/visualization-widgets/images/combo-box/combobox-multiselect.png)

 ***All*** - This allows you to select or unselect all the items in the combo box.

![Multiple Selection All](/static/assets/cloud/visualizing-data/visualization-widgets/images/combo-box/combobox-multiselect-all.png)
