...
![Stacked area chart](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/100%-Stacked-Area-Chart.png)
...
![Chart data](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/data-pane.png)
...
![Adding Y values](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/adding-y-values.PNG)

Now the chart will be rendered like this,

![Configured widget with Y values](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/configured-widget.PNG)

Click the `Settings` option to change required summary type from the available summary types shown in `Settings`.

![Settings menu](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/settings-menu.PNG)
...
![Sorting](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/sorting.PNG)
...
![Filtering](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/filtering.PNG)

To remove the added value fields click highlighted button.

![Remove fields](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/remove-fields.PNG)
...
![Drill alert](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/drillalert.PNG)
...
![Settings](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/settings.PNG)
...
![Sorting](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/sort-dimension.PNG)
...
![Dimension Filters](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/dimension-filters.PNG)
...
![Adding row](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/adding_row.PNG)
...
![Custom legend settings window](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/customlegendsettingwindow.PNG)
...
![Custom legend settings group](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/customlegendsettinggroup.PNG)

For example, If Display Format is {{ : Row }} ({{ : Value }}), then Legend series will display like Brazil (Sum of UnitsInStock)

![Custom legend settings](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/customlegendsetting.PNG)
...
![Filter settings](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/filter-settings.PNG)
...
![Container appearance](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/container-appearance.PNG)
...
![Chart grid lines](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/gridlines.PNG)
...
![Proportion chart series color palette](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/seriescolorpalette.PNG)
...
![Series color palette window](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/series-color-palette-window.PNG)

![Hundred percent area series color](/static/assets/cloud/visualizing-data/visualization-widgets/images/100-stacked-area-chart/series-color.PNG)
