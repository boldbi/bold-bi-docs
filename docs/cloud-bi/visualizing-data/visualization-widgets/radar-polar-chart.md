...
1.  Drag and drop the Radar/Polar chart widget into the canvas and resize it into your required size.
...
![Data tab](/static/assets/cloud/visualizing-data/visualization-widgets/images/radar-polar-chart/assign-data-section.png)
...
You can add maximum upto six series into `Value` field.
...
To format the Radar/Polar chart follow these steps:

1.  Drag and drop the Radar/Polar chart into the canvas and resize it to your required size.

2.  Configure the data into Radar/Polar chart.

3.  Focus on the Radar/Polar chart and click on widget settings icon.
...
> **NOTE:** The marker will not appear for the Scatter chart type in the Radar/Polar widget.
...
This allows you to switch from the current chart type to another chart type. The area chart is the default chart type in the radar polar chart. The other chart types are `Line, Spline, Area` and `Scatter.`
...
![Show Legend shape](/static/assets/cloud/visualizing-data/visualization-widgets/images/radar-polar-chart/legend-shape.png)
...
![Filter](/static/assets/cloud/visualizing-data/visualization-widgets/images/radar-polar-chart/filter.png)
...
This allows you to enable or disable the `comment` for the dashboard widget. For more details, refer to this [link](/cloud-bi/visualizing-data/working-with-widgets/commenting-widget/).
