...
> **NOTE:**  You can also create a data source from the home page by clicking the **Data Sources** menu from left menu panel and **Create Data Source** from the data sources page.
   ...
   ![Choose data source](/static/assets/cloud/working-with-datasource/data-connectors/images/Web/ChooseDS_Server.png)
...
4. If required by the REST API, provide key value pairs in **Headers**. To get details about headers, refer to [Query Parameters](/cloud-bi/working-with-data-source/data-connectors/web/#query-parameters).
...
7. Choose an **Authentication Type** supported by the data source. Options are *Basic http authentication* and *None*. Learn more about [Authentication Types](/cloud-bi/working-with-data-source/data-connectors/web/#authentication-types).
...
Options are [*None*](/cloud-bi/working-with-data-source/data-connectors/web/#none), [*Offset*](/cloud-bi/working-with-data-source/data-connectors/web/#offset), [*Next Page*](/cloud-bi/working-with-data-source/data-connectors/web/#next-page), [*Next Token*](/cloud-bi/working-with-data-source/data-connectors/web/#next-token), and [*Next URL*](/cloud-bi/working-with-data-source/data-connectors/web/#next-url).
