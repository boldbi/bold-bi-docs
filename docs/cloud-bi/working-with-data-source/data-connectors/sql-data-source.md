---
layout: post
title: Microsoft SQL – Cloud BI Connector | Bold BI Documentation
description: Learn how to connect SQL data sources with Bold BI. Also, know about the full update and incremental update refresh settings in Cloud BI.
platform: bold-bi
documentation: ug
---
...
To know more, please refer [here](/cloud-bi/working-with-data-source/user-filter/).
...
To know more, please refer [here](/cloud-bi/working-with-data-source/configuring-dashboard-parameters/#custom-query).
