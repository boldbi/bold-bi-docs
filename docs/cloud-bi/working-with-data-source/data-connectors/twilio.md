...
7. Choose **Basic http Authentication** under **Authentication Type** and input a valid **Username** and **Password**. Find the details for providing *Username* and *Password* from [here](/cloud-bi/working-with-data-source/twilio/#how-do-i-get-credentials-for-connecting-twilio-data-source)
