...
## Adding an expression column
  ...
  ![Add expression](/static/assets/cloud/working-with-datasource/images/addexpression.PNG)
   ...
   <b>Description:</b></br>
   Returns the smallest integer value that is greater than or equal to the given numeric expression.</br></ul>
   </td>
   </tr>
   <tr>
   <td>Numbers</td>
   ...
   <b>Description:</b></br>
   Returns the cotangent of the angle specified in radians, in the given expression.</br></ul>
   </td>
   </tr>
   <tr>
   <td>Numbers</td>
   ...
   <td>FLOOR</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> FLOOR(numeric_expression)</br>
   ...
   <td>MOD</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> MOD(numeric_expression, numeric_expression)</br>
   <b>Description:</b></br> Returns the reminder of the first numeric expression divided by second numeric expression.
   </br></ul>
   </td>
   </tr>
   <tr>
   ...
   <td>COALESCE</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> COALESCE(exp1,exp2,...exp(n))</br>
   <b>Description:</b></br> Returns the first non-NULL expression among its arguments, or NULL if all its arguments are NULL.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>CURRENTMONTH</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> CURRENTMONTH()</br>
   <b>Description:</b></br> Returns the current month.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>CURRENTYEAR</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> CURRENTYEAR()</br>
   <b>Description:</b></br> Returns the current year.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>PREVIOUSMONTH</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> PREVIOUSMONTH()</br>
   <b>Description:</b></br> Returns the previous month.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>PREVIOUSYEAR</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> PREVIOUSYEAR()</br>
   <b>Description:</b></br> Returns the previous year.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>YESTERDAY</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> YESTERDAY()</br>
   <b>Description:</b></br> Returns the yesterday date.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>REPLACE</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> REPLACE(string_expression, substring, new_substring)</br>
   <b>Description:</b></br> Replaces all occurrences of the substring within the given string expression, with the new_substring.</br>
   </ul>
   </td>
   </tr>
   <tr>
   ...
   <td>TRIM</td>
   <td><ul style="list-style-type:none">
   <b>Syntax:</b></br> TRIM(string_expression)</br>
   <b>Description:</b></br> Removes the leading and trailing spaces from the string expression.</br>
   </ul>
   </td>
   </tr>
   <tr>
...
## Configuring expression column in widgets
  ...
  ![Expression columns](/static/assets/cloud/working-with-datasource/images/expressioncolumns1.PNG)
   ...
   ![Aggregation function expression](/static/assets/cloud/working-with-datasource/images/aggregationfunctionsforexpressions.PNG)
