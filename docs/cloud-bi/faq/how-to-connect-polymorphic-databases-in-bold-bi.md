...
description: Learn the steps of how to connect polymorphic databases using Google Cloud SQL in Cloud Bold BI's Web designer to create powerful dashboards.
platform: bold-bi
documentation: ug
---
