...
<table>
    <tr>
        ...
        <td>
            <img alt="State Background Image" src = "/assets/cloud/site-administration/images/state-bg-image.png">
        </td>
    </tr>
</table>
...
<table>
    <tr>
        ...
        <td>
            <img alt="Primary Button" src = "/assets/cloud/site-administration/images/primary-btn-images.png">
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <img alt="Secondary Button" src = "/assets/cloud/site-administration/images/secondary-btn-images.png">
        </td>
    </tr>
    <tr>
        <td>
...
![Primary button](/static/assets/cloud/site-administration/images/primary-btn-images.png)
