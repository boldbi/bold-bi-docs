---
layout: post
title: Creating Dashboard Filters – Cloud BI | Bold BI Docs
description: Learn how to create dashboard filters to configure master-listener relationship between widgets in a dashboard in Bold BI Cloud.
platform: bold-bi
documentation: ug
---
...
![Select Filter](/static/assets/cloud/working-with-dashboards/images/select-filter.png)

![Filter Configuration](/static/assets/cloud/working-with-dashboards/images/filter-configuration.png)
...
![Adding widgets](/static/assets/cloud/working-with-dashboards/images/adding-widgets.png)
...
![Filter Criteria](/static/assets/cloud/working-with-dashboards/images/filter-criteria.png)
...
![Custom option](/static/assets/cloud/working-with-dashboards/images/Custom-option.png)
...
![Rename profile](/static/assets/cloud/working-with-dashboards/images/Rename-profile.png)
...
![Listener widget](/static/assets/cloud/working-with-dashboards/images/Listener-widget.png)
...
![Example for listener widget](/static/assets/cloud/working-with-dashboards/images/example-for-listener-widget.png)
...
![Filtered result for Grid](/static/assets/cloud/working-with-dashboards/images/Filtered-result-for-Grid.png)

On selecting the data in the combo box, the chart widget and grid widget show the particular detail.

![Filtered result for Combo box](/static/assets/cloud/working-with-dashboards/images/Filtered-result-for-Combo-box.png)
