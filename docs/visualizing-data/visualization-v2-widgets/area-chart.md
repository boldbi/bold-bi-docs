---
layout: post
title: Area Chart Widget (V2) – Embedded BI | Bold BI Documentation
description: Learn how to create a Area Chart (V2) visual in Bold BI Embedded dashboard, configure data fields and other settings.
canonical: "/visualizing-data/visualization-v2-widgets/area-chart/"
platform: bold-bi
control: Area Chart
documentation: ug
...
![Area Chart](/static/assets/visualizing-data/visualization-v2-widgets/images/area-chart/area-chart.png)
...
If you add more than one value to the Columns field, an alert message will be shown. Click Yes to enable drill down. Once enabled, clicking a category drills into the next level based on the Columns hierarchy.
...
This allows you to change the color for the area chart.
...
The color in the area chart widget can be customized using the color settings available in the properties section. This will allow users to improve the visualization and distinguish the data based on conditional range values.
...
Enter the legend title for the area chart.
...
This section allows you to handle the `filter` action for the area chart widget.
