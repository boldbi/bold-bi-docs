---
layout: post
title: Stacked Column Chart (V2) – Embedded BI | Bold BI Documentation
description: Learn how to create a Stacked Column Chart (V2) visual in Bold BI Embedded dashboard, configure data and other settings.
canonical: "/visualizing-data/visualization-v2-widgets/stacked-column-chart/"
platform: bold-bi
...
![Stacked Column Chart](/static/assets/visualizing-data/visualization-v2-widgets/images/stacked-column-chart/stackedcolumnchart.png)
...
This allows you to change the color for the stacked column chart.
...
The color in the stacked column chart widget can be customized using the color settings available in the properties section. This will allow users to improve the visualization and distinguish the data based on conditional range values.
...
Enter the legend title for the stacked column chart.
...
This section allows you to handle the `filter` action for the stacked column chart widget.
