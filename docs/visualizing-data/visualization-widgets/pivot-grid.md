...
You can filter the data to be displayed in pivot grid by using filter. For more details, refer [filter](/visualizing-data/working-with-widgets/configuring-widget-filters/).
...
You can format the data to be displayed in the pivot grid by using format option. For more details, refer [measure format](/visualizing-data/working-with-widgets/formatting-measure-type-column/)
...
Refer to the following sections for the detailed steps on using the [Gradient](/visualizing-data/visualization-widgets/pivot-grid/#gradient-mode) and [Rule](/visualizing-data/visualization-widgets/pivot-grid/#rule-based-condition-mode) modes. 
