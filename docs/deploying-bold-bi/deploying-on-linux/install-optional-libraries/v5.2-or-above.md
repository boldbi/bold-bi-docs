...
> **IMPORTANT:** Bold BI Enterprise Edition utilizes client libraries such as PostgreSQL, Oracle, MySQL, Snowflake, InfluxDB, MongoDB, Google and ClickHouse to establish connections with their respective SQL database variants. PostgreSQL will be installed by default. To install the client libraries other than PostgreSQL, you must read and accept the license agreement for each library.
