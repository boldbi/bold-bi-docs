...
description: Explore the prerequisites for installing Bold BI on your server and its deployment on Windows Server, Azure, Linux, and Kubernetes.
platform: bold-bi
documentation: ug
---
...
This section describes the prerequisites for installing Bold BI on your server. It also explains how to deploy it on supported platforms, including Windows, Azure, Linux, and Kubernetes.

Use the following pages for prerequisites and deployment steps:
