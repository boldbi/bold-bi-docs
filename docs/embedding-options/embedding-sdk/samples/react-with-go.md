...
4. Once the token is generated, it will be returned to the `Dashboard.js` file and the dashboard will start to render it.
...
16. Please replace the code in `package.json` with the `packages` listed in the following dependencies section. Installing these packages is essential.
      ...
      ```js
      {
        ...
        "private": true,
        "dependencies": {
          "@boldbi/boldbi-embedded-sdk": "^14.1.11",
