...
In this section, the details of public APIs are mentioned along with code snippets. This legacy API names (events, methods, and members) will be deprecated after one year from this v13.1 release. We strongly encourage to begin transitioning to the new naming [structure](https://help.boldbi.com/embedding-options/embedding-sdk/component-api-v2.0/) to ensure future compatibility.

* [Members](/embedding-options/embedding-sdk/component-api-v1.0/members/)
* [Methods](/embedding-options/embedding-sdk/component-api-v1.0/methods/)
* [Events](/embedding-options/embedding-sdk/component-api-v1.0/events/)