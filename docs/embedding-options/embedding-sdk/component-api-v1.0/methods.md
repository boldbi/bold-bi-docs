...
This method will render a programmatic multitab dashboard using either [dashboard IDs](/embedding-options/embedding-sdk/component-api-v1.0/members/#dashboardids) or [dashboard Paths](/embedding-options/embedding-sdk/component-api-v1.0/members/#dashboardpaths) while calling the create method.
...
> **NOTE:** Please refer to the new structure loadTabbedDashboards API [here](/embedding-options/embedding-sdk/component-api-v2.0/multi-tab/multi-tab-methods/#loadtabbeddashboards) from v13.1.
...
For more details, please click on the following [Embedded the dashboard with views](/embedding-options/embedding-sdk/embed-different-components/embed-view/).
