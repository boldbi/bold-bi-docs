...
You can embed the Bold BI dashboards in your web page by following the steps in this [link](/getting-started/embedding-in-your-application/).
...
So this property holds the URL of the embedding application that will implement authorization. Learn more about the authorization server [here](/security-configuration/authorize-server/).
...
Before setting the language to the dashboard in embedding level, you should have or generate respective language localization file in your Bold BI Server installed location. Please refer  [here](/localization/latest/#add-a-new-localization) to generate new locale file. Then, you can able to change the language by using the `appLocale` API in embedding level.
