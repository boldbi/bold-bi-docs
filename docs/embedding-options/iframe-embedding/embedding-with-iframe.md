...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>boolean</code></td>
      <td>
      Show preview as option in the dashboard designer with the default value set to <strong>false</strong>. To hide the preview as option, you can set the value of the <strong>hide_preview_as</strong> parameter to true.
      </td>
      <td>NA</td>
    </tr> 
    <tr>
