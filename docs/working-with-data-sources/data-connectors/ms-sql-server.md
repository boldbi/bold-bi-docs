...
To configure the dashboard parameter, refer to the [documentation.](/working-with-data-sources/dashboard-parameter/configuring-dashboard-parameter/#add-a-dashboard-parameter)
...
**Connecting to DataSource using REST API with Custom Attributes**
 ...
 ### For example, we configure a Microsoft SQL Server DataSource using a REST API.

Configuring a Microsoft SQL Server DataSource connection using **custom attributes** via an API involves setting up:
...
```
To know more about [Connecting Bold BI to Microsoft SQL Server Data Source via REST API](/working-with-data-sources/data-connectors/ms-sql-server/#Connecting-Bold-BI-to-Microsoft-SQL-Server-Data-Source-via-REST-API)
