...
5. To connect via already connected account, refer [Connected Accounts](/working-with-data-sources/data-connectors/infusionsoft/#connected-accounts-for-oauth-data-sources).
