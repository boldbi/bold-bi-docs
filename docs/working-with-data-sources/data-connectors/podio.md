...
5. To connect via an already connected account, refer to the [Connected Accounts](#connected-accounts-for-the-oauth-data-sources).
...
3. Click **Custom Url** to enter the URL manually. Refer to the [Podio API documentation](https://developers.podio.com/doc) for more details.
...
To know more about [Connected Accounts](/working-with-data-sources/working-with-connected-accounts/).
