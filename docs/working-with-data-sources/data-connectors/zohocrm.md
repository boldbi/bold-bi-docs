...
5. To connect via already connected account, refer to [Connected Accounts](/working-with-data-sources/data-connectors/zohocrm/#connected-accounts-for-oauth-data-sources).
