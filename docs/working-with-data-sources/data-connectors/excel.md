...
6. Here, Bold BI allows different `Import Type` and click [here](/working-with-data-sources/data-connectors/excel/#importing-data) to know more.
...
7. You can schedule refreshes to keep your data on the dashboard up to date using `Refresh Settings` option and click [here](/working-with-data-sources/data-connectors/excel/#refreshing-cloud-excel-data-source) to know more. 
...
Click [here](/working-with-data-sources/shared-table/) to know more.
