...
> **NOTE:** If you have already installed Bold Reports in your machine, please go to the [this section](/application-startup/#activate-bold-bi-license) to activate your Bold BI account.
...
> **NOTE:** To connect with PostgreSQL database you need to install PostgreSQL client library while installing the Bold BI Enterprise edition. Learn more [here](/deploying-bold-bi/deploying-in-windows/installation-and-deployment/#client-libraries).
...
[Click here to see the available storage options](/application-startup/#storage-options)
