...
If you do not have a Bold BI account, you can request a new trial from this [link](https://www.boldbi.com/embedded/pricing).
...
> **NOTE:** To connect with a PostgreSQL database, you need to install the PostgreSQL client library while installing the Bold BI Enterprise edition. Learn more [here](/deploying-bold-bi/deploying-in-windows/installation-and-deployment/#client-libraries).
...
> **NOTE:** The credentials given to connect to the server instance must have the permissions specified [here](/faq/what-are-the-database-permissions-required-to-set-up-bold-bi-embedded/).
...
> **NOTE:** The credentials provided to connect to the server instance must have the permissions specified [here](/faq/what-are-the-database-permissions-required-to-set-up-bold-bi-embedded/).  
...
> **NOTE:** The credentials provided for connecting to the server instance must have the permissions specified [here](/faq/what-are-the-database-permissions-required-to-set-up-bold-bi-embedded/).
...
Then, select the Bold BI Embedded tab.
