...
2. To create an authorization-server action method, copy the following sample in your controller. You can use the currently logged-in user email at `user@domain.com,` but this user should have write access to the pinboard. 
