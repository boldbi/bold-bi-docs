---
layout: post
title: Connect to Web data source | Embedded BI Dashboard Designer
description: Learn how to create data source by connecting to the Web data source through REST API in Embedded BI Dashboard Designer.
canonical: "/cloud-bi/working-with-data-source/data-connectors/web/"
platform: bold-bi
documentation: ug
---
...
3. Select the **Web** connection in the connection panel.
   ...
   ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/ChooseDS.png)

> **NOTE:**  You can also create a data source from the home page by clicking the **Data Sources** menu from left menu panel and **Create Data Source** from the data sources page.

   ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/ChooseDS_Server.png)
...
4. If required by the REST API, provide key value pairs in **Headers**. To get details about headers, refer to [Query Parameters](/embedded-bi/working-with-data-source/data-connectors/web/#query-parameters).
...
7. Choose an **Authentication Type** supported by the data source. Options are *Basic http authentication* and *None*. Learn more about [Authentication Types](/embedded-bi/working-with-data-source/data-connectors/web/#authentication-types).
...
Options are [*None*](/embedded-bi/working-with-data-source/data-connectors/web/#none), [*Offset*](/embedded-bi/working-with-data-source/data-connectors/web/#offset), [*Next Page*](/embedded-bi/working-with-data-source/data-connectors/web/#next-page), [*Next Token*](/embedded-bi/working-with-data-source/data-connectors/web/#next-token), and [*Next URL*](/embedded-bi/working-with-data-source/data-connectors/web/#next-url).
...
##### Sample for total records 
   ...
   ![TotalRecords](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/TotalRecords.png)

##### Sample for data indicator path

   ![Data Indicator Path](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/DataIndicatorPath.png)
...
##### Sample for total pages 
   ...
   ![TotalRecords](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/TotalPages.png)
...
##### Sample response
   ...
   ![Next Token](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/NextToken.png)
...
* Add header in Web API data source as below.
    ![Header Bearer View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Header_Bearer_View.png)

* You need to select the Authentication Type as None.
    ![Authentication View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Authentication_View.png)
...
* Most of the API Key authentication connect using Authorization header. You can also change the name of the header key as per your need.
    ![Header Basic View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Header_Basic_View.png)
...
Query String parameter will be added within the URL, so you can access the REST API without adding any header or body.
    ![Query String parameter View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Query_String_parameter_View.png)
...
* You need to select the Authentication Type as None since its API Key added in the Query String parameter.
    ![Authentication Type View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Authentication_Type_View.png)
...
* Choose POST method in Web API data source to add Body Data and add the API Key as below with relevant property names.
    ![Post method View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Post_Method_View.png)

* You need to select the Authentication Type as None since its API Key added as Body Data.
    ![Post Authentication Type View](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/Post_Authentication_Type_View.png)
...
![Showing configuration of relative date parameter with web url](/static/assets/embedded/working-with-datasource/data-connectors/images/Web/RelativeDateParsing.png)
