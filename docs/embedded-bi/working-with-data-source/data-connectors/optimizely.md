---
layout: post
title: Optimizely – Embedded BI Data Connector | Bold BI Docs
description: Learn how to connect Optimizely data through REST API endpoint with Bold BI Embedded and create data source for dashboard configuration.
canonical: "/cloud-bi/working-with-data-source/data-connectors/optimizely/"
platform: bold-bi
documentation: ug
---
...
3. Select the **Optimizely** connection in the connection panel.
    ...
    ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/optimizely/ChooseDS.png)

> **NOTE:**  You can also create a data source from the home page by clicking the **Data Sources** menu from left menu panel and **Create Data Source** from the data sources page.

   ![Choose data source from server](/static/assets/embedded/working-with-datasource/data-connectors/images/optimizely/ChooseDS_server.png)
...
8. Choose **None** under **Authentication Type** as authentication is done through header.
    ...
    ![DataSourcesView](/static/assets/embedded/working-with-datasource/data-connectors/images/optimizely/DataSourcesView.png)
...
![Reveal API Token](/static/assets/embedded/working-with-datasource/data-connectors/images/optimizely/APIToken.png)
