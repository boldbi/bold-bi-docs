...
canonical: "/cloud-bi/working-with-data-source/data-connectors/fitbit/"
platform: bold-bi
documentation: ug
---
...
3. Select the **Fitbit** connection in the connection panel.
   ...
   ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/Fitbit/ChooseDS.png)

> **NOTE:** You can also create a data source from the home page by clicking the **Data Sources** menu from the left menu panel and **Create Data Source** from the data sources page.

   ![Choose data source from server](/static/assets/embedded/working-with-datasource/data-connectors/images/Fitbit/ChooseDS_Server.png)
...
![Data source preview](/static/assets/embedded/working-with-datasource/data-connectors/images/Fitbit/DataSourcesView.png)
