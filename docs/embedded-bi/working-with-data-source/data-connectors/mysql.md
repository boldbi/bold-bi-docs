---
layout: post
title: MySQL – Embedded BI Connector | Bold BI Documentation
description: Learn how to connect MySQL database with Bold BI Embedded in both live and extract modes. Also know about the refresh settings in extract mode.
canonical: "/cloud-bi/working-with-data-source/data-connectors/mysql/"
platform: bold-bi
documentation: ug
---
...
3. Select the **MySQL** connection in the connection panel.
   ...
   ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/Mysql/ChooseDS.png)

> **NOTE:**  You can also create a data source from the home page by clicking the **Data Sources** menu from left menu panel and **Create Data Source** from the data sources page.

   ![Choose data source](/static/assets/embedded/working-with-datasource/data-connectors/images/Mysql/ChooseDS_server.png)
...
![Live Connection](/static/assets/embedded/working-with-datasource/data-connectors/images/Mysql/Mysql_Live_Connection.png)
...
> **NOTE:**  Initially, data will be extracted based on the Max Rows selected in order to proceed with data model creation. The remaining records (there is no limit) will be extracted during the next refresh.  <br /> 
 ![Max rows option](/static/assets/embedded/working-with-datasource/data-connectors/images/Mysql/maxRowOption.png#max-width=60%)
...
### Parameters for creating Data Source
   ...
   <b>required</b> </td>
   <td>`string`</br></br>
   Port number used to connect to the mysql server.</br></br>
   </td>
   </tr>
   <tr>
   <td>Username</br></br>
