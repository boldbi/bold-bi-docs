...
![Grid widget](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid-widget.png)
...
![Properties icon](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/properties-icon.png)
...
You can Sort the data using `Sort` option under Settings menu list. Click [here](/embedded-bi/visualizing-data/working-with-widgets/advanced-sorting/) for the detailed steps.

![Sorting menu item](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/sorting-menu.png)
...
![Column names](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/column-name.png)

1. Click the settings menu icon and select the `Rename` menu option.
![Rename menu item](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/rename-menu.png)

2. The column name can become editable now. Enter the required text and press `enter` key.
![Editing field name](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/edit-name.png)

3. Now, the changes will be reflected in the grid widget.
![After rename](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/after-renaming.png)
...
![Basic settings](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_basicsetting.png)
...
![Grid Row Height](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_alternativerowcolor.png)

### Header Settings
This section allows you to format the grid header visibility, color, and font-size.

![Grid Row Height](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_headersettings.png)
...
![Header background color](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_headercustomized.png)

### Content Settings
This section allows you to format the grid row height, color, and font-size.

![Grid Row Height](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_contentsetting.png)
...
![Header background color](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_contentcustomized.png)
...
![Column settings](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_columnSetting.png)
...
![Column customize button](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_columnalign.png)
...
![Column settings](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_formattingDataList.jpeg)

For each of those columns, the value representation can be configured using the options displayed at the right side.

![Configured columns](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_formattingRadioField.jpeg)
...
![Bar Customize button](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_barCustomizeButton.jpeg)

Dialog can be opened by selecting the `Bar` radio button for initial configuration, thereafter, click the `Customize` button.

![Bar setting](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_barSettingDialog.jpeg)
...
![Bar shape](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_barShape.jpeg)
...
![Formatting progress bar](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_formattingProgressBar.jpeg)
...
![Container appearance properties](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/container-settings.png)
...
![Modes](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/color-modes.png)
...
![Font style](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/font-style.png)
...
![Colors](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/colors.png)
...
![Apply conditions](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/apply-conditions.png)
