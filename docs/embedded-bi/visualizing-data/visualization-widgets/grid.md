...
![Grid Row Height](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/grid_row_height.png)

### Column Header
This section allows you to format the grid cells. 
![Formatting properties](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/Grid_columnHeader.jpeg)
...
![Header background color](/static/assets/embedded/visualizing-data/visualization-widgets/images/grid/header-background-color.png)
