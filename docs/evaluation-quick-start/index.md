---
layout: post
title: Bold BI Evaluation Quick Start | Bold BI Documentation
description: Use the Evaluation Quick Start to explore sample dashboards, help resources, and a free cloud trial to evaluate self-service and embedded analytics.
...
This section guides you through essential evaluation components of the platform. It enables you to gain both conceptual understanding and limited hands-on experience before full deployment or integration begins.

This guide focuses on evaluation tasks and resources; it does not cover production deployment or full integration steps.
...
## Compare with Other BI Platforms
...
This section provides access to detailed comparisons. These resources are intended to assist evaluators and decision-makers in making an informed selection based on organizational goals and use cases.
