...
The embed URL should be in the following format; to get `create datasource URl,` refer [here](/embedded-bi/iframe-based/get-datasource-url/).
...
<td>URL of the data source to establish a new connection. To know more, click <a href="/embedded-bi/iframe-based/get-datasource-url/">here.</a></td>
</tr>
...
The embed URL should be in the following format; to get `edit datasource URL,` refer [here](/embedded-bi/iframe-based/get-datasource-url/).
...
<td>URL of the data source to be embedded. To know more, click <a href="/embedded-bi/iframe-based/get-datasource-url/">here.</a></td>
</tr>
