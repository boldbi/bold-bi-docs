...
canonical: "/working-with-data-source/data-connectors/odbc/"
platform: bold-bi
documentation: ug
---
...
> **Note:** ODBC Connector is available in Bold BI Embedded Analytics but not in Cloud Analytics Server.
