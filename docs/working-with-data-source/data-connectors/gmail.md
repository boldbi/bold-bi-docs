...
canonical: "/working-with-data-source/data-connectors/gmail/"
platform: bold-bi
documentation: ug
---
...
> **Note:** Gmail data source is available in Bold BI Embedded Analytics but not in Cloud Analytics Server.
...
> **Note:** Google OAuth credentials are required for the Bold BI Embedded Analytics but not needed in Cloud Analytics Server.
