...
4. Click the **Custom Url** to enter the URL manually. Refer to the [ServiceNow API documentation](https://developer.servicenow.com/app.do#!/rest_api_doc) for more details.
