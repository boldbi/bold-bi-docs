...
> **NOTE:** Wistia data source is available in Cloud Analytics Server and it is not available in Bold BI Embedded Analytics.
...
5. To connect using existing connected account, refer  [Connected Accounts](/working-with-data-source/data-connectors/wistia/#connected-accounts-for-oauth-data-sources).
