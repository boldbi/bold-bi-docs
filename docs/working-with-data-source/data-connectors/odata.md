...
8. To connect based on the chosen Authentication, refer [Supported Authentication Types](/working-with-data-source/data-connectors/odata/#authentication-for-odata).
