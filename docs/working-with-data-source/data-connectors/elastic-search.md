...
![Data source connection](/static/assets/embedded/working-with-datasource/data-connectors/images/Elastic-search/elasticsearchlive.png#max-width=100%)
...
![Data source connection](/static/assets/embedded/working-with-datasource/data-connectors/images/Elastic-search/elasticsearchextract.png#max-width=100%)
...
![Open distro connection](/static/assets/embedded/working-with-datasource/data-connectors/images/Elastic-search/opendistrolive.png#max-width=100%)
...
![Custom query connection](/static/assets/embedded/working-with-datasource/data-connectors/images/Elastic-search/customquery.png#max-width=70%)
...
The detailed steps to connect using open distro connection type is explained in the below document.
[AWS Open Search](/embedded-bi/working-with-data-source/data-connectors/aws-opensearch/#connecting-bold-bi-to-aws-open-search-data-source-via-rest-api) 
...
### Parameters for creating Data Source
   ...
   <b>optional</b>  </td>
   <td>`string`</br></br>
   A valid username for the connection. Required for basichttpauthentication</td>
   </tr>
   <tr>
   <td>Password</br></br>
   <b>optional</b>  </td>
   <td>`string`</br></br>
   A valid Password for the connection. Required for basichttpauthentication</td>
   </tr>
   <tr>
   <td>Database</br></br>
   <b>required</b> </td>
...
"Connection": [</br></br>
{</br></br>
"ConnectionType": "Open Distro",</br></br>
"Servername": "string",</br></br>
"Port": "string",</br></br>
"AuthenticationType": "string",</br></br>
