...
Select the JSON file downloaded from [Connecting with Service Authentication](/working-with-data-source/data-connectors/google-bigquery/#connecting-with-service-authentication) 
