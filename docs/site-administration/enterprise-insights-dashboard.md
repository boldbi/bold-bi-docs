---
layout: post
title: Enterprise Insights Dashboard – Embedded BI | Bold BI Docs
...
The Enterprise Insights dashboard is predefined and allows you to monitor dashboard activity in order to better understand how users are interacting with dashboards.

The Enterprise Insights dashboards can be found in the `Enterprise Insights` category on the dashboard listing page.

![Usage Analytics Dashboard](/static/assets/site-administration/images/usage-analytics-dashboard.png#width=60%)

You can choose to show or hide the Enterprise Insights category on the dashboard listing page by selecting the [Enterprise Insights](/site-administration/dashboard-settings/enterprise-insights/) option in the dashboard settings page.

> **NOTE:**  The `Enterprise Insights` option is available only to admin users, and Enterprise Insights dashboards are read-only.
...
The embedded analytics dashboard is preconfigured to track and analyze the performance of each embedded dashboard activity, such as dashboard views.

![Embedded Analytics1](/static/assets/site-administration/images/embedded-analytics1.png#width=60%)

![Embedded Analytics2](/static/assets/site-administration/images/embedded-analytics2.png#width=60%)

### Embedded Analytics Dashboard Widgets Details
...
<table>
        ...
        <tr>
            ...
            <td>
                The total number of anonymous users.
            </td>
        </tr>
        <tr>
            <td>
