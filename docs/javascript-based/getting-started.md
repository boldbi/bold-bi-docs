...
* The `Dashboard Parameter` filter must be started with a double ampersand `&&` in the endpoint. Refer to this [link](/embedded-bi/working-with-data-source/dashboard-parameter/configuring-dashboard-parameters/) for more details.   
