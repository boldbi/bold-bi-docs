...
This method will used to get instance of that specific widget using Id. To get the widget details from specific dashboard, please refer this [REST API](/embedded-bi/javascript-based/widget-embedding/#how-to-get-widget-id).
...
> **NOTE:** Customize the `createDashboardCategory()` in the dashboard designer using web application. To know more details, please refer to [here](/embedded-bi/faq/how-to-create-own-publish-dialog-for-designer-embedding/).
...
> **NOTE:** Customize the `getDashboardCategories()` in the dashboard designer using web application. To know more details, please refer to [here](/embedded-bi/faq/how-to-create-own-publish-dialog-for-designer-embedding/).
...
> **NOTE:** Customize the `saveDashboard()` in the dashboard designer using web application. To know more details, please refer to [here](/embedded-bi/faq/how-to-create-own-publish-dialog-for-designer-embedding/).
