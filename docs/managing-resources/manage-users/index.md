...
You can also select multiple scopes and entities to assign multiple permissions. Please visit [Manage Permissions](/managing-resources/manage-permissions/) for more information on how to add and manage permissions.
